...
A simple ML churn  model trained using open-source tools. Experiments, API and front-end deployment are done using DVC, MLflow, Flask, GitHub actions, and Heroku. Finally, production model monitoring is done using EvidentlyAI.
